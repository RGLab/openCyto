...
#' 
#' @slot name a \code{character} specifying the name of the gating method
#' @slot dims a \code{character} vector specifying the dimensions (channels or markers) of the gate
#' @slot args a \code{list} specifying the arguments passed to gating function
#' @slot groupBy a \code{character} or \code{integer} specifying how to group the data
#' if a \code{character},group the data by the study variables (columns in \code{pData})
#' if a \code{integer},  group the data by every \code{N} samples.
#' @slot collapse a \code{logical} specifying wether to collapse the data within group before gating
...
#' 
#' It extends \code{gtMethod} class.
#' @slot refNodes \code{character} specifying the reference nodes        
...
#' 
#' @slot id \code{numeric} unique ID that is consistent with node label of graphNEL in gating template 
#' @slot name \code{character} the name of population
#' @slot alias \code{character} the more user friendly name of population
...
#' 
#' parsing the arguments read from `args` columns of csv template into list of paired arguments
