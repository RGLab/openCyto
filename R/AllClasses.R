...
# for the purpose of method dispatching setClass('fcFilterList2d'
# ,contains='fcFilterList' )
# 
# a flowClust tree is a container to hold priors and posteriors that can be
...
#    names(paired_args) <- tolower(names(paired_args)) #duh!
  } else {
